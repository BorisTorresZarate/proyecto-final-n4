  ...
  return (
    <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-3xl p-6 shadow-xl mb-6">
      <div className="flex flex-wrap gap-4 mb-4 ">
          ...
          />
          <label htmlFor="pendiente" className="mr-1">Pendiente</label>
          <input
            type="checkbox"
            id="enProceso"
            value="en proceso"
      ...
      <div className="flex flex-wrap gap-4">
        <input
          type="date"
          name="desde"
          className="bg-transparent border border-gray-600 p-2 rounded-lg hover:border-blue-600 text-white"
          placeholder="Desde"
        ...
        <input
          type="text"
          name="asignado"
          className="bg-transparent border border-gray-600 p-2 rounded-lg hover:border-blue-600 text-white placeholder:text-white"
